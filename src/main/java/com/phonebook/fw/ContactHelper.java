...
public class ContactHelper  extends BaseHelper {
    ...
    public void addNewContactPositiveData(String name) {
        ...
        fillInNewContactForm(
                //new Contact(name,  "LastNameTest", "1234567890", "admin@gmail.com", "Germany, Berlin", "Some Description"));
                new Contact()
                        .setName(name)
    ...
    public int actualSizeOfContacts() {
        if (hasContacts()) {
            // Считаем количество контактов по классу contact-item_card__2SOIM
